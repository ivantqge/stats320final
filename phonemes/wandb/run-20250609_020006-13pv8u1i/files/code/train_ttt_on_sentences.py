...
def create_default_config():
    ...
    return {
        ...
        'model': {
            'type': 'TTT_RNN',  # Now using real TTT implementation
            ...
            'use_enhanced_ttt': False,  # Use basic TTT with real gradient steps
            'ttt_config': {
                'inner_encoder': 'mlp_2',  # More expressive encoder
                'inner_iterations': 2,  # More iterations for better adaptation
        ...
        'training': {
            ...
            'grad_clip_norm': 1.0,  
            'log_freq': 5,  
            'save_freq': 5,  # Save every epoch
            'weight_decay': 0  # Removed weight decay to avoid AdamW issues
        }
    }
